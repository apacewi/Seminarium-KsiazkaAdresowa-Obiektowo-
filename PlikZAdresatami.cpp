...
string PlikZAdresatami::zamienDaneAdresataNaLinieZDanymiOddzielonymiPionowymiKreskami(Adresat adresat) {
    ...
    liniaZDanymiAdresata += metodyPomocnicze.konwerjsaIntNaString(adresat.pobierzNumerTelefonu()) + '|';
    ...
    for (int pozycjaZnaku = 0; pozycjaZnaku < daneAdresataOddzielonePionowymiKreskami.length(); pozycjaZnaku++) {
        if (daneAdresataOddzielonePionowymiKreskami[pozycjaZnaku] != '|') {
            ...
            case 4:
                ...
                break;
            case 5:
                adresat.ustawNumerTelefonu(metodyPomocnicze.konwersjaStringNaInt(pojedynczaDanaAdresata));
                break;
            case 6:
...
vector <Adresat> PlikZAdresatami::pobierzWektorZAdresatami() {
    return adresaci;
}
